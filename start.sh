...
export FLUX_DEV_DIR="../fshare/models/black-forest-labs/FLUX.1-dev"
# export FLUX_DEV_FP8="../fshare/models/XLabs-AI/flux-dev-fp8/flux-dev-fp8.safetensors"
export FLUX_DEV_FP8="../fssd/models/ckpt/flux-dev-fp8.safetensors"
export FLUX_SCHNELL="../fshare/models/black-forest-labs/FLUX.1-schnell/flux1-schnell.safetensors"
export FLUX_SCHNELL_DIR="../fshare/models/black-forest-labs/FLUX.1-schnell"
